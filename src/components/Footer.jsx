    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="flex flex-col sm:grid grid-cols-[2fr_1fr_1fr_1fr] gap-14 my-10 mt-34 text-sm">
        <div>
          ...
          <p className="w-full text-gray-600 mt-8 border-b-2 pb-2">
            Connect With Us
          </p>
          <div className="flex gap-4 mt-4">
            <img
              className="h-7 cursor-pointer transform hover:-translate-y-2 transition duration-300 ease-in-out hover:scale-110"
        ...
        <div>
          ...
          <ul className="flex flex-col gap-1 text-gray-600">
            <li className="hover:text-black cursor-pointer">Customer Help</li>
            <li className="hover:text-black cursor-pointer">
              About Forever House Rewards
            </li>
            <li className="hover:text-black cursor-pointer">Order Help</li>
            <li className="hover:text-black cursor-pointer">
              Shipping and Handling
            </li>
            <li className="hover:text-black cursor-pointer">Online Returns</li>
            <li className="hover:text-black cursor-pointer">Track My Order</li>
            <li className="hover:text-black cursor-pointer">Cards & E-Cards</li>
            <li className="hover:text-black cursor-pointer">
              Student Discount
            </li>
      ...
      <div>
        <hr />
        <ul className="flex flex-wrap gap-1 text-gray-600 text-sm mt-5 mb-5 pt-2 pb-20">
          <li className="underline hover:text-black cursor-pointer">
            Privacy/Ad Cookies
          </li>
          <li className="border-l border-gray-400 pl-2 underline hover:text-black cursor-pointer">
            Sale Terms
          </li>
          <li className="border-l border-gray-400 pl-2 underline hover:text-black cursor-pointer">
            Text Terms
